        ...
        <main role="main">
          ...
          <article className='article-recent'>
            <div className='article-recent-main'>
              ...
              <p className='article-body'>My first three years of university can be summarized as me studying a bunch of subjects with no direction. On the side in my first year, I studied data science, which subsequently transitioned to cloud over the next two years. Toward the conclusion of my third year, I finally decided to pause and thoroughly consider what I wanted to pursue, what I was truly interested in. I came to the conclusion that I wanted to create...</p>
